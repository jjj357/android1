...
public class DateTimePicker implements OnClickListener
{
	...
	public static Calendar calendar_date=null;
	
	private Activity activity;
	
	public static ICustomDateTimeListener iCustomDateTimeListener = null;
	...
	public void onClick(View v) 
	{
		switch (v.getId()) 
	    {
		 ...
		 case SET:     	if(dialog.isShowing())
			            ...
			            //resetData();
		            	//Intent i = new Intent(this, PickDateTimeActivity.class);
		            	//startActivity(i);
		                break;
